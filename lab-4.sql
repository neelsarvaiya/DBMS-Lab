...
UPDATE student SET SPI = 8.00 where spi = 7.00; 
...
UPDATE student SET SPI = 9.20 , city = 'VADODARA' where sname = 'DEEP';

--4. Update SPI of DHARMIK to 8.50.
UPDATE student SET spi = 8.50 where sname = 'DHARMIK';
...
UPDATE STUDENT SET BRANCH = 'EC' , SPI = 8.00 , CITY = 'SURAT' WHERE SNAME = 'KRUNAL';
